...
class SaleOrder(models.Model):
    ...
    report_amount_mrc = fields.Monetary(string='Report Total MRC', store=False, readonly=False, track_visibility='onchange')
    report_amount_nrc = fields.Monetary(string='Report Total NRC', store=False, readonly=False, track_visibility='onchange')
